...
DROP TABLE IF EXISTS actors_rols;
...
FROM actors_rols INNER JOIN movies ON movies.id = actors_rols.movie_id
                 INNER JOIN actors ON actors.id = actors_rols.actor_id;
